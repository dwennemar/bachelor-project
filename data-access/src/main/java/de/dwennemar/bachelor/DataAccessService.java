...
@EnableSwagger2
@Component
public class DataAccessService implements WebMvcConfigurer, RepositoryRestConfigurer {

    public static void main(String[] args) {
        SpringApplication.run(DataAccessService.class, args);
    }
